...
export default function DonationForm({ selectedPlan, onChangePlan }: DonationFormProps) {
  ...
  const sendWhatsApp = (number: string) => {
    const qtyText = selectedPlan === "1" ? "criança" : "crianças";
    const msg = `Oii, quero abençoar ${selectedPlan} ${qtyText} e vou fazer no ${paymentMethod}${name ? " — Me chamo " + name : ""} 🙏`;
    window.open(`https://wa.me/${number}?text=${encodeURIComponent(msg)}`, "_blank");
    setShowPicker(false);
  };

  return (
    <section id="donation-form" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-[1100px] mx-auto px-6 relative z-[1]">
        ...
        <div
          id="form-container"
          className="max-w-[600px] mx-auto mt-14 bg-[var(--bg3)] border border-[rgba(201,150,59,0.2)] rounded-md p-8 md:p-12 relative z-[1] transition-shadow duration-500 reveal"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full bg-[rgba(255,255,255,0.04)] border border-[rgba(201,150,59,0.15)] rounded-sm px-4 py-3 text-[var(--text)] font-sans text-[0.95rem] outline-none transition-all duration-200 focus:border-[var(--gold)] focus:shadow-[0_0_0_3px_rgba(201,150,59,0.1)]"
              />
            </div>
            <div className="mb-5">
          ...
          <div className="mb-5">
            ...
            <select
              ...
              className="w-full bg-[rgba(255,255,255,0.04)] border border-[rgba(201,150,59,0.15)] rounded-sm px-4 py-3 text-[var(--text)] font-sans text-[0.95rem] outline-none transition-all duration-200 focus:border-[var(--gold)] focus:shadow-[0_0_0_3px_rgba(201,150,59,0.1)] appearance-none cursor-pointer"
              style={{
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`py-3.5 border rounded-sm text-center cursor-pointer transition-all duration-200 text-[0.9rem] flex items-center justify-center gap-2 ${
          ...
          <div className="relative w-full" ref={pickerRef}>
            <button
              ...
              className="w-full py-[18px] bg-gradient-to-br from-[#25d366] to-[#128c7e] border-none rounded-sm text-white font-sans text-[1rem] font-semibold cursor-pointer flex items-center justify-center gap-3 transition-all duration-300 tracking-[0.02em] hover:-translate-y-0.5 hover:shadow-[0_10px_40px_rgba(37,211,102,0.25)]"
            >
